classdef CST_MicrowaveStudio < handle
    ...
    methods
        function obj = CST_MicrowaveStudio(folder,filename)
            ...
            if nargin == 0
                ...
                obj.CST = actxserver('CSTStudio.application.2021');
            ...
            if exist(ff,'file') == 2
                ...
                obj.CST = actxserver('CSTStudio.application.2024');
        ...
        function savekak(obj,folder,name)
             obj.mws.invoke('saveas',fullfile(folder,name),'false');
        ...
        function setTimeDomainSolver(obj)

            VBA = sprintf(['Mesh.SetCreator "High Frequency"\n\n',...
                'With Solver\n',...
                '.Method "Hexahedral"\n',...
        ...
        %             invoke(s,'Reset');
        %             invoke(s,'MaximumNumberOfCPUDevices',4);
        %             invoke(s,'AutoNormImpedance',"True");
        %             invoke(s,'NormingImpedance',"50");
        %             invoke(s,'SteadyStateLimit',"-60");
        %             invoke(s,'HardwareAcceleration',"True");
        %             invoke(s,'MaximumNumberOfGPUs',"1");

        %             s = obj.mws.invoke('FDSolver'); % handle to frequency domain solver
        %             invoke(s,'Reset');
        %             invoke(s,'AddSampleInterval',"", "", "2", "Automatic", "True" );
        %             invoke(s,'AddSampleInterval', "", "", "", "Automatic", "False" );
        %             invoke(s,'MaximumNumberOfCPUDevices',4);
        %             invoke(s,'Type',"Direct");
    ...
    methods (Static)
        function [CST,mws] = openFile(folder,filename)
            ...
            CST = actxserver('CSTStudio.application.2024');
